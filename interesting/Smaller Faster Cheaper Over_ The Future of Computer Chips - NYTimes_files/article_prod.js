...
PluginManager.registerWidget({
      ...
      showFn: function(event) {
        ...
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"iframeSrc","default_value":""},{"name":"click1","default_value":"1"},{"name":"click2","default_value":"2"},{"name":"click3","default_value":"3"},{"name":"click4","default_value":"4"},{"name":"campaignIds","default_value":""},{"name":"nytID","default_value":""},{"name":"parentCSS","default_value":""},{"name":"iframeCSS","default_value":""},{"name":"iframeJS","default_value":""},{"name":"itemsForRemove","default_value":""},{"name":"parentHTML","default_value":"<div id=\"optimizelyIframeContainer\"></div>"},{"name":"addAfterItem","default_value":""},{"name":"testElement","default_value":".product__container__content"},{"name":"optly_disable","default_value":"0"},{"name":"custom_js","default_value":""}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
        ...
        var processElement = function() {
            ...
            require(['auth/mtr'], function(Mtr) {
                ...
                for (i = 0; i < links.length; ++i) {
                    ...
                    if (!url || (
                        !url.match(/myaccount/) &&
                        !url.match(/subscriptions/)))  { continue; }
            ...
            if(typeof campaignIds === "object") {
                for (var i = 0; i < campaignIds.length; ++i) {
                    doc.querySelectorAll(campaignIds[i][0]).forEach(function(link) {
                        var href = link.href; 
                      	if (!href) {
                          console.log('[ERROR] There is no "href" attribute for the selector.');
                          return;
                        };
...
PluginManager.registerWidget({
      ...
      showFn: function(event) {
        ...
        widget.$instance = event.data.id;
        widget.$render = _template.render.bind(_template)
        widget.$fieldDefaults = [{"name":"iframeSrc","default_value":""},{"name":"click1","default_value":"1"},{"name":"click2","default_value":"2"},{"name":"click3","default_value":"3"},{"name":"click4","default_value":"4"},{"name":"campaignIds","default_value":""},{"name":"nytID","default_value":""},{"name":"parentCSS","default_value":""},{"name":"iframeCSS","default_value":""},{"name":"iframeJS","default_value":""},{"name":"itemsForRemove","default_value":""},{"name":"addAfterItem","default_value":""},{"name":"testElement","default_value":".product__container__content"},{"name":"interstitial_meter","default_value":"6"},{"name":"optly_disable","default_value":"0"},{"name":"custom_js","default_value":"var initClose = function () {\n    $('body').on('click', '.nytdGrowlNotifyCross', function () {\n        // $('#Interstitial_optly').fadeOut('slow');\n        $('#Interstitial_optly').hide();\n        $('body').removeClass('noScroll');\n    });\n};\n$('body').addClass('noScroll');\n\ninitClose();"},{"name":"parentHTML","default_value":"<div id=\"optimizelyIframeContainer\"></div>"}];
        (function(widg) {
  var i = 0;
  var field;
  for (; i < widg.$fieldDefaults.length; ++i) {
