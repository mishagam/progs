...
CanvasVideoPlayer.prototype.init = function() {
  //patched to original lib to get correct video height.
  var self = this;
  this.video.addEventListener('loadedmetadata', function(){
    self.setCanvasSize();
    if (self.options.hideVideo) {
  ...
  if (this.options.hideVideo) {
    this.video.style.visiblity = 'hidden';
  }
};
...
CanvasVideoPlayer.prototype.loop = function() {
  ...
  if (this.video.currentTime >= this.video.duration) {
    this.playing = false;
    // Patch to original lib to dispatch an end event
    this.canvas.dispatchEvent(endEvent);
