...
},{"./lib/analytics-services/chartbeat":2,"./lib/analytics-services/comscore":4,"./lib/analytics-services/omniture":7,"./lib/element-tracker":10,"./lib/init-report":11,"./lib/track-scrolling":13}],2:[function(require,module,exports){
  ...
  */
  ...
  s.sendDataToOmniture = function(customLinkName, events, props, options) {
    ...
    if (typeof options === 'object') {
      if (options.immediate) {
        if (!omnitureState.readyState) omnitureState.setReady();
      }
    }
  ...
  function waitForPaywallTracking(setTimer, checkCount) {
      ...
      if ((s && window.TWP && TWP.Identity && TWP.Identity.paywall && TWP.Identity.paywall.pwresp) || checkCount > 6 || setTimer != true) {
  		...
  		$(window.document).off("onTwpMeterComplete.omniture");
          window.console && console.log && console.log("OMNITURE - PAYWALL VARIABLES: 60: " + s.eVar60 + " 64:" + s.eVar64 + " 65: " + s.eVar65 + " 66: " + s.eVar66);
      } else {
          setTimeout(function() {
  ...
  if ((typeof _suppressTrackPageLoad == 'undefined' || !_suppressTrackPageLoad) && !config.suppressTrackPageLoad) {
      if (window.TWP &&
          ...
          $(window.document).on("onTwpMeterComplete.omniture", function(event) {
...
},{"./init":8,"./state":9}],8:[function(require,module,exports){
...
},{"../../state-store":12}],10:[function(require,module,exports){
...
StateStore.prototype.ready = function(cb) {
  if (this.readyState) {
    ...
    console.log(this.service + ' - waiting for ' + this.eventName);
    var _self = this;
    $(window.document).one(this.eventName, function() {
      _self.readyState = true;
      console.log(_self.service + ' - ready');
      return cb();
    });
  }
};
