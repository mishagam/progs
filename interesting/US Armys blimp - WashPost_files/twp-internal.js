(function() {	
	...
	TWP.jsCacheBuster = TWP.jsCacheBuster || '20151008134100';
	...
	TWP.ScriptLoader.loadCJS = function () {
		if (typeof CJS == 'undefined') {
			...
			jsControlJs = '|<script type="text/cjs" data-cjssrc="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/controljs/control-mod.js"></script>';		
	...
	if (typeof jQuery == 'undefined'){
		...
		var jsJQuery = '|<script type="text/javascript" src="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/jquery-1.7.1.js"></script>';				
	...
	var jsList = '';
				...
				jsList = jsList + '|<script type="text/javascript" src="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/conf.js&r=/actmgmt/acctmgmt_common.js&r=/plugin/plugin.jquery.cookie-1.0.0.js"></script>';			
	
				jsList = jsList + '|<script type="text/cjs" data-cjssrc="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/core-1.0.0.js&r=/constants-1.0.0.js&r=/static-methods-1.0.0.js&r=/util/util.cookie-1.0.0.js"></script>';			
	
				jsList = jsList + '|<script type="text/javascript" src="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/plugin/plugin.jquery.tools.overlay.1.2.7mod.js&r=/plugin/plugin.jquery.tools.overlay.apple.js&r=/plugin/plugin.jquery.tools.toolbox.expose.js"></script>';			
	
				jsList = jsList + '|<script type="text/javascript" src="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/util/util-user-2.0.0.js&r=/util/util.identity-management-1.1.0.js"></script>';			
	
				jsList = jsList + '|<script type="text/cjs" data-cjssrc="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/marketing/identity-retargeting.js"></script>';			
	
				jsList = jsList + '|<script type="text/cjs" data-cjssrc="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/plugin/plugin.jquery.parseparams.js&r=/plugin/plugin.jquery.imageLazyLoader-1.0.0.js&r=/module/module.menus-2.0.0.js&r=/module/module.external-header-v4-2.0.0.js&r=/module/module.external-footer-v4-2.0.0.js&r=/util/util.track-click-1.0.0.js&r=/init/init.track-header-1.0.0.js&r=/util/util.header-detection-1.1.0.js"></script>';			
	
				jsList = jsList + '|<script type="text/javascript" src="https://js.washingtonpost.com/wpost/js/combo?token=20151008134100&c=true&m=true&context=eidos&r=/wapo/wapo_sites.js&r=/wapo/wapolabs.nojq.full.js&r=/wapo/prod/wapo_identity_full.js"></script>';			
	;
	...
	var cssList = '';
				...
				cssList = cssList + '|<link rel="stylesheet" type="text/css" href="https://css.washingtonpost.com/wpost/css/combo?token=20150701150800&inttoken=201510130600&c=true&m=true&context=eidos&r=/2.0.0/external-header-base.css&r=/2.0.0/fonts.css&r=/2.0.0/header.css&r=/2.0.0/footer.css" />';
				...
				cssList = cssList + '|<link rel="stylesheet" type="text/css" href="https://css.washingtonpost.com/wpost/css/combo?token=20150701150800&inttoken=201510130600&c=true&m=true&context=eidos&r=/2.0.0/ads.css" />';
