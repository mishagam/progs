 ...
 ***********************/
     var globalNav = {
         ...
         initSearch: function(){
            ...
            var wikiSearchForm = document.getElementById('nav_search');     //
            var searchSelect = document.getElementById('gs_siteAlias');
            var wikiSearchSelect = document.getElementById('ns_filter');   //
            if(searchForm){
				searchForm.onsubmit = function(){
					if(this.elements["query"].value == ""){
						...
						if(searchSelect.value == 'bc_video'){
							location.href = "/video/search/" + this.elements["query"].value;
							return false;
							...
							searchForm.appendChild(newNode);
							searchForm.action = "http://howto.wired.com/wiki/Special:Search";
						}
						return true;
					}
				};
            ...
            if(wikiSearchForm){
				wikiSearchForm.onsubmit = function(){
					if(this.elements["query"].value == ""){
						return false;
					}else{
						if(wikiSearchSelect.value == 'bc_video'){
							location.href = "/video/search/" + this.elements["query"].value;
							return false;
						} else if(wikiSearchSelect.value == "wiki"){
							wikiSearchForm.action = "http://howto.wired.com/wiki/Special:Search";
						}
						return true;
					}
				};
...
function updateSearchOptions() {
	...
	if(search) {
		search.query.setAttribute("autocomplete", "on");
		search.query.setAttribute("size", "19");
		search.query.setAttribute("id", "q");
		
		var isHowto = false;
		if(location.href == "http://howto.wired.com/") {
			isHowto = true;
		}
		
		search.siteAlias.options[0].setAttribute("value", "010858178366868418930:fk33zkiunj8");
		search.siteAlias.options[1].setAttribute("value", "010858178366868418930:wgkajfviehq");
		search.siteAlias.options[1].text = "Product Reviews";
		search.siteAlias.options[2].setAttribute("value", "010858178366868418930:thuf3pyyazi");
		search.siteAlias.options[3].setAttribute("value", "wiki");
		search.siteAlias.options[3].text = "HowTo";
		search.siteAlias.setAttribute("name", "cx");
		
		newNode = document.createElement("input");
		newNode.setAttribute("type", "hidden");
		newNode.setAttribute("name", "cof");
		newNode.setAttribute("value", "FORID:9");
		search.appendChild(newNode);
		newNode = document.createElement("input");
		newNode.setAttribute("type", "hidden");
		newNode.setAttribute("name", "ie");
		newNode.setAttribute("value", "UTF-8");
		search.appendChild(newNode);
    }
    var wikiSearch = document.getElementById('nav_search');
    if(wikiSearch) {
		...
		for(var i=0; i<5; i++){
		    if(!wikiSearch.siteAlias.options[i]){
		        wikiSearch.siteAlias.appendChild(document.createElement('option'))
		    }
		}
		wikiSearch.siteAlias.options[0].setAttribute("value", "010858178366868418930:fk33zkiunj8");
		wikiSearch.siteAlias.options[0].setAttribute("id", "all_wired");
		wikiSearch.siteAlias.options[0].setAttribute("id", "all_wired");
		wikiSearch.siteAlias.options[0].text = "All Wired";
		wikiSearch.siteAlias.options[1].setAttribute("value", "010858178366868418930:wgkajfviehq");
    	wikiSearch.siteAlias.options[1].setAttribute("id", "reviews");
    	wikiSearch.siteAlias.options[1].setAttribute("name", "reviews");
		wikiSearch.siteAlias.options[1].text = "Product Reviews";
		wikiSearch.siteAlias.options[2].setAttribute("value", "010858178366868418930:thuf3pyyazi");
		wikiSearch.siteAlias.options[3].setAttribute("value", "wiki");
		wikiSearch.siteAlias.options[3].setAttribute("name", "wiki");
		wikiSearch.siteAlias.options[3].text = "HowTo";
		wikiSearch.siteAlias.options[3].selected = true;
		wikiSearch.siteAlias.options[4].setAttribute("value", "bc_video");
		wikiSearch.siteAlias.options[4].setAttribute("name", "bc_video");
		wikiSearch.siteAlias.options[4].setAttribute("id", "bc_video");
		wikiSearch.siteAlias.options[4].text = "Video";
		wikiSearch.siteAlias.setAttribute("name", "cx");
		
		newNode = document.createElement("input");
		newNode.setAttribute("type", "hidden");
		newNode.setAttribute("name", "cof");
		newNode.setAttribute("value", "FORID:9");
		wikiSearch.appendChild(newNode);
		newNode = document.createElement("input");
		newNode.setAttribute("type", "hidden");
		newNode.setAttribute("name", "ie");
		newNode.setAttribute("value", "UTF-8");
