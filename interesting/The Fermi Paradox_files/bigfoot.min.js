...
(function(e){e.bigfoot2=function(t){function i(t,n){var r,i,s,o;t.each(function(){var t=e(this);s="#"+t.attr("href").split("#")[1];r=t.closest("sup");i=t.find("sup");if(r.length>0){o=(r.attr("id")||"")+(t.attr("id")||"");n.push(r.attr({"data-footnote2-backlink-ref":o,"data-footnote2-ref":s}))}else if(i.length>0){o=(i.attr("id")||"")+(t.attr("id")||"");n.push(t.attr({"data-footnote2-backlink-ref":o,"data-footnote2-ref":s}))}else{o=t.attr("id")||"";n.push(t.attr({"data-footnote2-backlink-ref":o,"data-footnote2-ref":s}))}})}function s(e){if(e.is(":empty")||e.children(":not(.hidden)").length==0){var t=e.parent();n.actionOriginalFN.toLowerCase()==="delete"?e.remove():e.addClass("hidden").css({display:"none"});s(t)}else if(e.children(":not(.hidden)").length==e.children("hr:not(.hidden)").length){var t=e.parent();if(n.actionOriginalFN.toLowerCase()==="delete")e.remove();else{e.children("hr").addClass("hidden").css({display:"none"});e.addClass("hidden").css({display:"none"})}s(t)}}function o(e,t){t.indexOf(" ")>=0&&(t=t.trim().replace(/ +/g,"|").replace(/(.*)/g,"($1)"));var n="(s|&nbsp;)*<s*a[^#<]*#"+t+"[^>]*>(.*?)<s*/s*a>",r=new RegExp(n,"g");return e.replace(r,"").replace("[]","")}function u(e,t,n){var r=new RegExp("{{"+t+":([^}]*)}}","g"),i,s,o;while(i=r.exec(e))if(i[1]){s=n.attr(i[1])||"";e=e.replace("{{"+t+":"+i[1]+"}}",s)}return e}function d(t,r){t=t||".footnote2-content";r=r||n.popoverDeleteDelay;e(t).each(function(){var t=e('.footnote2-button[data-footnote2-identifier="'+e(this).attr("data-footnote2-identifier")+'"]'),n=e(this);if(t.hasClass("changing"))return;t.removeClass("active hover-instantiated click-instantiated").addClass("changing");n.removeClass("active").addClass("disapearing");setTimeout(function(){n.remove();t.removeClass("changing")},r)});return e(t.replace(".footnote2-content",".footnote2-button"))}function m(e,t){t=t||.5;var n=e.find(".tooltip");n.length>0&&n.css({left:t*100+"%"})}function g(t){var n=parseFloat(t.outerWidth()),r=parseFloat(t.outerHeight()),i=y(),s=t.offset().top-e(window).scrollTop()+r/2,o=t.offset().left+n/2;return{topRoom:s,bottomRoom:i.height-s,leftRoom:o,rightRoom:i.width-o,leftRelative:o/i.width,topRelative:s/i.height}}function y(){var e=document.createElement("div");e.style.cssText="position: fixed;top: 0;left: 0;bottom: 0;right: 0;";document.documentElement.insertBefore(e,document.documentElement.firstChild);var t={width:e.offsetWidth,height:e.offsetHeight};document.documentElement.removeChild(e);return t}var n=e.extend({actionOriginalFN:"hide",activateOnHover:!1,allowMultipleFN:!1,appendPopoversTo:undefined,deleteOnUnhover:!1,hoverDelay:250,popoverDeleteDelay:500,popoverCreateDelay:100,positionNextToBlock:!0,positionContent:!0,preventPageScroll:!0,scope:!1,contentMarkup:'<aside class="footnote2-content bottom"data-footnote2-identifier="{{footnote2NUM}}" alt="footnote2 {{footnote2NUM}}"><div class="footnote2-main-wrapper"><div class="footnote2-content-wrapper">{{footnote2CONTENT}}</div></div><div class="tooltip"></div></aside>',buttonMarkup:'<a href="#" class="footnote2-button" data-footnote2-identifier="{{footnote2NUM}}" alt="See footnote2 {{footnote2NUM}}" rel="footnote2"data-footnote2-content="{{footnote2CONTENT}}"><span>{{footnote2NUM}}</span></a>'},t),r=function(){var t;t=n.scope?n.scope+' a[href*="#"]':'a[href*="#"]';var r=e(t).filter(function(){var t=e(this),n=t.attr("rel");if(!n||n=="null")n="";return(t.attr("href")+n).match(/(fn|footnote2|note2)[:\-_\d]/gi)&&t.closest("[class*=footnote2]:not(a):not(sup)").length<1}),a=[],f=[],l=[],c,h;i(r,f);e(f).each(function(){c=e(this).attr("data-footnote2-ref").replace(":","\\:");h=e(c).closest("li");if(h.length>0){a.push(h);l.push(this)}});for(var p=0;p<a.length;p++){var d=o(e(a[p]).html().trim(),e(l[p]).data("footnote2-backlink-ref")).replace(/"/g,"&quot;").replace(/&lt;/g,"&ltsym;").replace(/&gt;/g,"&gtsym;"),v=+(p+1),m="",g;d.indexOf("<")!==0&&(d="<p>"+d+"</p>");m=n.buttonMarkup.replace(/\{\{footnote2NUM\}\}/g,v).replace(/\{\{footnote2CONTENT\}\}/g,d);m=u(m,"SUP",e(l[p]));m=u(m,"FN",e(a[p]));g=e(m).insertAfter(e(l[p]));e(l[p]).remove();var y=e(a[p]).parent();switch(n.actionOriginalFN.toLowerCase()){case"delete":e(a[p]).remove();s(y);break;case"hide":e(a[p]).addClass("hidden").css({display:"none"});s(y)}}},a=function(t){if(n.activateOnHover){var r=e(t.target).closest(".footnote2-button"),i='[data-footnote2-identifier="'+r.attr("data-footnote2-identifier")+'"]';if(r.hasClass("active"))return;r.addClass("hover-instantiated");if(!n.allowMultipleFN){var s=".footnote2-content:not("+i+")";d(s)}c(".footnote2-button"+i).addClass("hover-instantiated")}},f=function(t){var n=e(t.target),r=n.closest(".footnote2-button");$nearfootnote2=n.closest(".footnote2-content");if(r.length>0){t.preventDefault();l(r)}else $nearfootnote2.length<1&&e(".footnote2-content").length>0&&d()},l=function(e){e.blur();var t='data-footnote2-identifier="'+e.attr("data-footnote2-identifier")+'"';if(e.hasClass("changing"))return;if(!e.hasClass("active")){e.addClass("changing");setTimeout(function(){e.removeClass("changing")},n.popoverCreateDelay);c(".footnote2-button["+t+"]");e.addClass("click-instantiated");n.allowMultipleFN||d(".footnote2-content:not(["+t+"])")}else n.allowMultipleFN?d(".footnote2-content["+t+"]"):d()},c=function(t){t=t||".footnote2-button";if(n.allowMultipleFN)var r=e(t).closest(".footnote2-button");else var r=e(t+":first").closest(".footnote2-button");r.each(function(){var t=e(this);try{var r=n.contentMarkup.replace(/\{\{footnote2NUM\}\}/g,t.attr("data-footnote2-identifier")).replace(/\{\{footnote2CONTENT\}\}/g,t.attr("data-footnote2-content").replace(/&gtsym;/,"&gt;").replace(/&ltsym;/,"&lt;"));r=u(r,"BUTTON",t)}finally{if(!n.appendPopoversTo){$nearestBlock=t.closest("p, div, pre, li, ul, section, article, main, aside");$siblingfootnote2=$nearestBlock.siblings(".footnote2-content:last");$siblingfootnote2.length>0?$content=e(r).insertAfter($siblingfootnote2):$content=e(r).insertAfter($nearestBlock)}else $content=e(r).appendTo(n.appendPopoversTo+":first");$content.attr("data-bigfoot-max-height",$content.height());v();t.addClass("active");$content.find(".footnote2-content-wrapper").bindScrollHandler()}});var i=e(t.replace(".footnote2-button",".footnote2-content"));setTimeout(function(){i.addClass("active")},n.popoverCreateDelay);return i};e.fn.bindScrollHandler=function(){if(!n.preventPageScroll)return;e(this).on("DOMMouseScroll mousewheel",function(t){var n=e(this),r=n.scrollTop(),i=n[0].scrollHeight,s=parseInt(n.css("height")),o=n.closest(".footnote2-content");n.scrollTop()>0&&n.scrollTop()<10&&o.addClass("scrollable");if(!o.hasClass("scrollable"))return;var u=t.type=="DOMMouseScroll"?t.originalEvent.detail*-40:t.originalEvent.wheelDelta,a=u>0,f=function(){t.stopPropagation();t.preventDefault();t.returnValue=!1;return!1};if(!a&&-u>i-s-r){n.scrollTop(i);o.addClass("fully-scrolled");return f()}if(a&&u>r){n.scrollTop(0);o.removeClass("fully-scrolled");return f()}o.removeClass("fully-scrolled")})};var h=function(t){n.deleteOnUnhover&&n.activateOnHover&&setTimeout(function(){var n=e(t.target).closest(".footnote2-content, .footnote2-button");e(".footnote2-button:hover, .footnote2-content:hover").length<1&&d()},n.hoverDelay)},p=function(e){e.keyCode==27&&d()},v=function(){n.positionContent&&e(".footnote2-content").each(function(){var t=e(this),n='data-footnote2-identifier="'+t.attr("data-footnote2-identifier")+'"',r=t.find(".footnote2-content-wrapper"),i=e(".footnote2-button["+n+"]"),s=g(i),o=parseFloat(t.css("width")),u=parseFloat(t.css("margin-top")),a=+t.attr("data-bigfoot-max-height"),f=2*u+a,l=1e4;if(s.bottomRoom<f&&s.topRoom>s.bottomRoom){t.css({top:"auto",bottom:s.bottomRoom+"px"}).addClass("top").removeClass("bottom");l=s.topRoom-u-15;t.css({"transform-origin":s.leftRelative*100+"% 100%"})}else{t.css({bottom:"auto",top:s.topRoom+"px"}).addClass("bottom").removeClass("top");l=s.bottomRoom-u-15;t.css({"transform-origin":s.leftRelative*100+"% 0%"})}t.find(".footnote2-content-wrapper").css({"max-height":Math.min(l,a)+"px"});t.css({left:s.leftRoom-s.leftRelative*o+"px"});m(t,s.leftRelative);parseInt(t.css("height"))<t.find(".footnote2-content-wrapper")[0].scrollHeight&&t.addClass("scrollable")})},b=function(e,t){var r=n[e];n[e]=t;return r},w=function(e){return n[e]};e(document).ready(function(){r();e(document).on("mouseenter",".footnote2-button",a);e(document).on("touchend click",f);e(document).on("mouseout",".hover-instantiated",h);e(document).on("keyup",p);e(window).on("scroll resize",v)});return{close:function(e,t){return d(e,t)},activate:function(e){return c(e)},reposition:function(){return v()},getSetting:function(e){return w(e)},updateSetting:function(e,t){return b(e,t)}}}})(jQuery);