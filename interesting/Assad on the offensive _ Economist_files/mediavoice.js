...
var renderRightRailContent2 = function(){
  ...
  if (url.indexOf("blogs/economist-explains") > -1 == false){
    ...
    var html = [
      ...
      '<div style="display:none;" id="block-ec_blogs-ec_blogs_block_recent" class="block block-ec_blogs mv-block2">',
        '<div class="content clearfix">',
          '<div class="title mv-sponsor-title" style="padding-bottom: 7px !important; border-bottom: white !important; border-bottom-width: 1px !important; border-bottom-style: solid !important;">',
            '<h6>More articles from GE Look ahead</h6>',
          '</div>',
          '<dl>',
            '<div id="mediavoice-placeholderB" style="display:none"></div>',
          '</dl>',
        '</div>',
      '</div>',
      '<div class="content clearfix" style="padding-top: 12px;"></div>',
      ].join('');
    $(html).insertAfter($('#block-ec_mostx-mostpopular'));
    backColor = '#d4e8fc';
  }
}();

var renderEconExplainsContent = function(){
var url = window.location.href;

  if (url.indexOf("economist-explains") > -1){


    var html = [


      '<div style="display:none; background-color:#d4e8fc;" id="block-ec_blogs-ec_blogs_block_recent" class="block block-ec_blogs mv-block">',


        '<div class="content clearfix">',


          '<div class="title mv-sponsor-title2" style="background-color:#d4e8fc;">',


            '<h6>Advertisement Feature</h6>',
          ...
          '<dl class="mv-dl2">',
            ...
            '<div id="mediavoice-placeholderEE" style="display:none"></div>',
    ...
    $(html).insertAfter($('.item-list .views-row-2'));
...
var renderGraphicDetailContent = function(){
var url = window.location.href;

  if (url.indexOf("graphicdetail") > -1){
      ...
      '<div style="display:none; background-color:#d4e8fc;" id="block-ec_blogs-ec_blogs_block_recent" class="block block-ec_blogs mv-block">',
        ...
        '<div class="content clearfix">',
          ...
          '<dl class="mv-dl2">',
            ...
            '<div id="mediavoice-placeholder2" style="display:none"></div>',
...
try {
  ...
  var theLabel23 = "Right Rail- Products & events - 3 ";
    theLabel23 = theLabel23.concat(prop4, " - ", channel);
  var theLabel3 = "Right Rail- Products & events - Economist Explains - 1 ";
    theLabel3 = theLabel3.concat(prop4, " - ", channel);
  var theLabel4 = "Right Rail- Products & events - Economist Explains - 2 ";
    theLabel4 = theLabel4.concat(prop4, " - ", channel);
  var theLabel5 = "Right Rail- Products & events - Economist Explains - 3 ";
    theLabel5 = theLabel5.concat(prop4, " - ", channel);
  var theLabel6 = "Graphic Details - Blog Stream ";
    theLabel6 = theLabel6.concat(prop4, " - ", channel);
  var theLabelEE = "Economist Explains Details - Blog Stream ";
    theLabelEE = theLabelEE.concat(prop4, " - ", channel);
...
window.NATIVEADS.onReady = function(ads) {
  ...
  try{
    newAdUnit = "/5605/" + Drupal.settings.ecAds.ad_site + "." + Drupal.settings.ecAds.sitecode + "/" + Drupal.settings.ecAds.ad_zone;
  }catch(err){
    newAdUnit = '';
  }
  ads.insertPreview({
  ...
  ads.insertPreview({
    label: theLabel23,
    unit: {"server":"dfp","id":"/5605/NativeAds","size":"2x2","targets":{"pos":"productevents","prop41":prop41,"prop42":prop42,"order":"3"}},
    location: "#mediavoice-placeholder3",
    infoText: "",
    infoButtonText: "",
    template: compiledTemplate0,
  ...
  ads.insertPreview({
    label: theLabel3,
    unit: {"server":"dfp","id":newAdUnit,"size":"2x2","targets":{"pos":"economistexplains","order":"1"}},
    location: "#mediavoice-placeholderB",
    infoText: "",
    infoButtonText: "",
    template: compiledTemplate0,
    onRender: function($element) { },
  ...
  ads.insertPreview({
    label: theLabel4,
    unit: {"server":"dfp","id":newAdUnit,"size":"2x2","targets":{"pos":"economistexplains","order":"2"}},
    location: "#mediavoice-placeholderB",
    infoText: "",
    infoButtonText: "",
    template: compiledTemplate0,
...
ads.insertPreview({
    label: theLabel5,
    unit: {"server":"dfp","id":newAdUnit,"size":"2x2","targets":{"pos":"economistexplains","order":"3"}},
    location: "#mediavoice-placeholderB",
    infoText: "",
    infoButtonText: "",
    template: compiledTemplate0,
...
var graphicSelector = "#mediavoice-placeholder2";
var econexplainsSelector = "#mediavoice-placeholderEE";
  ...
  ads.insertPreview({
    ...
    unit: {"server":"dfp","id":"/5605/NativeAds","size":"2x2","targets":{"pos":"graphicdetails","prop41":prop41,"prop42":prop42}},


    location: graphicSelector,
    ...
    unit: {"server":"dfp","id":"/5605/NativeAds","size":"2x2","targets":{"pos":"econexplainsfeed","prop41":prop41,"prop42":prop42}},


    location: econexplainsSelector,
  ...
  ads.configureSecondaryPage({
    ...
    onRender: function() {
      ...
      $("#column-content .typog-content-header.main-content-header .fly-title").append("<span style=\'float:right\'>Advertisement Feature</span>");
      $(".content-image-full > img").attr("src",$(".content-image-full > img").attr("src").split("&h=")[0]);
  ...
  <div class="latest_blogs clearfix" data-href-redirect="{{link}}">
      <dt>
          <a href="{{link}}">
            ...
            <img class="sponsor-logo" src="{{sponsor.logo.href}}" height="15" width="auto">
            {{summary}}
          </a>
      </dt>
  </div>
...
<div class="views-row views-row-1 views-row-odd views-row-first omniture-tagged omniture-tagged-6 mv-ad2" style="padding-bottom:145px;">


    <div class="latest_blogs clearfix" data-href-redirect="{{link}}">


        <div class="main-content clearleft">


            <dt>


                <a href="{{link}}" class="floatleft">


                    <img src="{{image.href}}" alt="" title="" class="imagecache imagecache-blogs-teaser" height="200">


                </a>


                <p class="mv-ad2-title">
                ...
                <p class="mv-summary">
                    ...
                    <a href="{{link}}" style="text-decoration: none;">{{summary}}</a> 


                </p>


        <p class="more-link mv-view-more">
...
">
  ...
  <div style="
    float: left;
">Presented by</div> <div style="
    float: left;
">
  <img class="sponsor-logo2" src="{{sponsor.logo.href}}" width="40" style="
    padding-left: 7px;
">
</div>
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"views-row views-row-1 views-row-odd views-row-first omniture-tagged omniture-tagged-6 mv-ad2\" style=\"padding-bottom:145px;\">\n\n\n    <div class=\"latest_blogs clearfix\" data-href-redirect=\"";
  if (stack1 = helpers.link) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.link; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n\n\n        <div class=\"main-content clearleft\">\n\n\n            <dt>\n\n\n                <a href=\"";
  ...
  buffer += escapeExpression(stack1)
    ...
    + "\" alt=\"\" title=\"\" class=\"imagecache imagecache-blogs-teaser\" height=\"200\">\n\n\n                </a>\n\n\n                <p class=\"mv-ad2-title\">\n\n\n                    <strong>";
