...
if (typeof s_account == "undefined") {
  var s_account = window.darwin_notify_rsid;
}
...
function s_doPlugins(s) {
  ...
  if (jQuery.cookie('ec_omniture_user_sub') === null) {
    s.prop13 = 'anonymous';
  }
  else {
    s.prop13 = jQuery.cookie('ec_omniture_user_sub');
  }
  // Set the cookie to bulk-IP if Varnish has set the community.
  if (jQuery.cookie('ec_community') == "10000000000") {
    s.prop13 = 'bulk-IP';
  }
  ...
  if (s.prop4 == "article" && s.prop13.indexOf('subscriber') == -1) {
    ...
    var nidlist = jQuery.cookie('ec_nidlist');
    if (nidlist) {
      ...
      if (jQuery.inArray(Drupal.settings.nid, nidlist) != -1) {
        article_count = 0;
      }
