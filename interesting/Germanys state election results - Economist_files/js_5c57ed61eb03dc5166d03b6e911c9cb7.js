      ...
      case 'message':
        if (args.form_id == 'comment_form') {
          ...
          if(errors.length > 0) {
            ...
            if (errors[0]['value'].length > 0) {
              // First, remove any other error messages.
              $('.messages-error-processed').remove();
              $('<div class="messages messages-error messages-error-processed">' + errors[0]['value'] + '</div>').insertBefore('.main-content-header');
            }
