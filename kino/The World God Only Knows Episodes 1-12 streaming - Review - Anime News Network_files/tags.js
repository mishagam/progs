...
if (e9Manager === undefined || e9Manager.init === false)
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   host: "a.tribalfusion.com",
  	   busterframe: "http://www.animenewsnetwork.com/images/s/157/10477.tfBuster.html",
  	   busterDomain: "",
		...
		var e9Ad = 
		 {
		   ...
		   setAdReqParams:    
			...
			if (adSpec.env === "display" || adSpec.env === "toolbar")
                         {
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("animenewsnetwork","ros");
