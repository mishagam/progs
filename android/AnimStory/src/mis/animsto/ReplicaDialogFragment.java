...
public class ReplicaDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
	    ...
	    builder.setView(inflater.inflate(R.layout.replica_dialog, null))
	    // Add action buttons
	           .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
	               @Override
	               public void onClick(DialogInterface dialog, int id) {
	            	   EditText replTextView=(EditText) 
	            			   ((AlertDialog) dialog).findViewById(R.id.replica_text);
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mListener = (NewReplicaListener) activity;
        } catch (ClassCastException e) {
            // The activity doesn't implement the interface, throw exception
            throw new ClassCastException(activity.toString()
                    + " must implement NewReplicaListener");
        }
    }
