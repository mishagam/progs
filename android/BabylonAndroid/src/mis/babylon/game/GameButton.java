...
public class GameButton extends MisFigure {
    public static final int BUTTON_SIZE = 52; 
    OnClickListener listener = null;
    MisContext myContext = null;
    
    public GameButton() {
        super();
    }
    
    public GameButton(MisContext context, String image) {
        super();
        myContext = context;
        TexSquare md = new TexSquare(this);
        md.setSize(BUTTON_SIZE, BUTTON_SIZE, 0);
    ...
    public GameButton(MisContext context, String image, int sx, int sy) {
        super();
        myContext = context;
        TexSquare md = new TexSquare(this);
        md.setSize(sx, sy, 0);
