...
Didn't work in Fedora 12 11.18.2012 M.G.
worked under Windows XP 11.18.2012 M.G.
 ************************************************/


public class AudioCapture2 extends JFrame {
	...
	public AudioCapture2() {// constructor
	...
	private void captureAudio() {
		try {
			...
			Mixer mixer = AudioSystem.getMixer(mixerInfo[4]); // M.G.
	...
	private void playAudio() {
		try {
			...
			System.out.println("FGot data line: " + sourceDataLine);
		...
		public void run() {
			try {
				...
				while ((cnt = audioInputStream.read(tempBuffer, 0,
						tempBuffer.length)) != -1) {
					System.out.println("Read buffer in PlayThread");
					if (cnt > 0) {
